...
<div class="max-w-7xl mx-auto px-4 py-4 sm:py-5 flex justify-between items-center relative">
    ...
    <nav class="hidden md:flex gap-10 text-sm font-semibold uppercase tracking-wider absolute left-1/2 -translate-x-1/2">
    ...
    <div class="flex items-center gap-2 sm:gap-4">
        ...
        <button id="mobileMenuButton" type="button"
            class="md:hidden inline-flex items-center justify-center w-8 h-8 rounded-lg border border-white/10 bg-white/[0.03] text-slate-300 hover:text-white hover:border-white/20 transition-colors"
